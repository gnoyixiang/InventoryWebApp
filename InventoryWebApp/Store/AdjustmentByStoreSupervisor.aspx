...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active"><a href="#">Adjustment By Supervisor</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <asp:GridView ID="gvPendingAdjutment" runat="server" GridLines="None" Width="100%" AutoGenerateColumns="false" DataKeyNames="AdjustmentCode"
                OnRowDataBound="gvPendingAdjutment_RowDataBound" OnRowCommand="gvPendingAdjutment_RowCommand" CellSpacing="-1" CssClass="table">
                <Columns>
