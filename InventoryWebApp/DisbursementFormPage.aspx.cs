...
namespace InventoryWebApp
{
    public partial class DisbursementFormPage : System.Web.UI.Page
    {
        ...
        {
            ddlDepartment.DataSource = ddlCollectionPoint.SelectedValue == "ALL" ? sClerkCtrl.GetDisbursingDepartmentList(sClerkCtrl.GetDisbursingDisbursements()): 
                sClerkCtrl.GetDisbursingDepartmentList(sClerkCtrl.GetDisbursementListByCollectionPoint(ddlCollectionPoint.SelectedValue));
            ddlDepartment.DataTextField = "DepartmentName";
            ddlDepartment.DataValueField = "DepartmentCode";
            ddlDepartment.DataBind();
        ...
        protected void lvDisbursementDetails_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            lblTest.Text = e.NewValues["Notes"].ToString();
